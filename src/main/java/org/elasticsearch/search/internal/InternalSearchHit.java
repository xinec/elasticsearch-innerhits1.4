...
public class InternalSearchHit implements SearchHit {
    ...
    public InternalSearchHit(int docId, String id, Text type, InternalNestedIdentity nestedIdentity, Map<String, SearchHitField> fields) {
        this.docId = docId;
        this.id = new StringAndBytesText(id);
        this.type = type;
        this.fields = fields;
    ...
    public void readFrom(StreamInput in, InternalSearchHits.StreamContext context) throws IOException {
        ...
        if (in.getVersion().onOrAfter(Version.V_1_5_0)) {
            ...
            //nestedIdentity =  new InternalNestedIdentity();
        }
        version = in.readLong();
